...
template <typename T, typename F> struct splay_tree_array_ushi_node {
...
struct splay_tree_array_ushi
    : splay_tree_base<splay_tree_array_ushi_node<T, F>> {
    ...
    inline void insert(int idx, T val) {
        return super::insert(idx, new node(val, op));
    }
