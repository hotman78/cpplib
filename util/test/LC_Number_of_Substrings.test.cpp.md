...
data:
  ...
  bundledCode: "#line 1 \"util/test/LC_Number_of_Substrings.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/number_of_substrings\"\n#line 2 \"util/ACL.hpp\"\
    \n#include <algorithm>\n#include <array>\n#ifdef _MSC_VER\n#include <intrin.h>\n\
    #endif\nnamespace atcoder {\nnamespace internal {\n// @param n `0 <= n`\n// @return\
    ...
    \ 4 \"util/test/LC_Number_of_Substrings.test.cpp\"\n\nint main(){\n    using namespace\
  ...
  requiredBy: []
  timestamp: '2020-09-14 22:59:21+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: util/test/LC_Number_of_Substrings.test.cpp
layout: document
redirect_from:
- /verify/util/test/LC_Number_of_Substrings.test.cpp
- /verify/util/test/LC_Number_of_Substrings.test.cpp.html
